...
# define data folder
dataFolder<-"D:/Dropbox/GitHub/Data/"
# read .txt file
...
# write .RDS file
saveRDS(rice.data, "D:/Dropbox/GitHub/Data/rice_data.rds")
```
...
library(haven)
# write .sav file
haven::write_sav(rice.data, "D:/Dropbox/GitHub/Data/rice_data.sav")
```
...
library(haven)
# write .sav file
haven::write_sas(rice.data, "D:/Dropbox/GitHub/Data/rice_data.sas7bdat")
```
...
::: callout-note
glimps() of dplyr is a improved function of r-base str().
:::
