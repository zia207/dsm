...
soil %>%
    ...
    dplyr::select(SOC, ELEV, NDVI, MAP, MAT) %>%
...
2. Create a R-Markdown Project using this Homework directory as shown before.

3. Create a R-Markdown  documents (name homework_01.rmd) in this project and do all Tasks (1 to 23) using the data shown below. 

4. Submit all codes and output  as a HTML document (homework_01.html) before class of next week. 
...
23. Clean bd_soil_data_raw.csv and save as bd_soil_data.final.csv.
:::
