...
1. Create a R-Markdown Project using this Homework directory as shown before.

2. Create a R-Markdown  documents (name homework_02.rmd) in this project and do all Tasks (1 to 6) using the data shown below. 
...
1. Use row_to_names() remove text from column heading

2. Remove empty rows and columns using remove_empty()

3. Clean column names using clean_names()
